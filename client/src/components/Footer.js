...
export default function Footer() {
    ...
    const onsubmitfun = async (event) => {
        try {
            ...
            let url = 'http://localhost:5000/api/user/feedback';
                ...
                <div className="row mx-0">
                    ...
                    <div className="col-md-3 mx-auto text-center mb-2">
                        ...
                        <form onSubmit={onsubmitfun}>
                            <input onChange={onchangefun} name="name"  value={user.name} type="text" placeholder="Name" style={{ textAlign: 'center', outline: 'none', marginBottom: '7px', borderRadius: '20px', padding: '2px',border:'none' }} /><br />
                            <input onChange={onchangefun} name="message" value={user.message} type="text" placeholder="Message Me" style={{ textAlign: 'center', outline: 'none', borderRadius: '20px', padding: '2px',border:'none' }} /><br />
